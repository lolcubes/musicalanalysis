...
for i in $(ls /Users/svernooy/Desktop/GCRSEF2019/Test); do 
    for j in {1..34}; do
        /Users/svernooy/Desktop/GCRSEF2019/Order_of_Execution/$j/$j.sh /Users/svernooy/Desktop/GCRSEF2019/Test/$i | tr '\n' ';' ;
    done > /Users/svernooy/Desktop/GCRSEF2019/Outputs/$i; 
done